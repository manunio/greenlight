...
func main() {
	...
	// TODO: / NOTE: don't hard-code dsn, and pass it via flag
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://greenlight:pa55word@localhost:5431/greenlight?sslmode=disable", "PostgreSQL DSN")
