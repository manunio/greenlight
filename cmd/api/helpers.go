...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	// and error instead of just ignoring the field.
	...
	if err != nil {
		...
		case errors.Is(err, io.ErrUnexpectedEOF):
			return errors.New("body contains badly informed JSON")
		...
		// then Decode will now return an error message in format "json: unknown
